...
class StoreTest {
    ...
    ///
    private Flower flower3 = new Flower(5,Color.Black,10,FlowerType.Rose);
    private FlowerPack pack3 = new FlowerPack(flower1,5);
    private Flower flower4 = new Flower(4,Color.Red,7,FlowerType.Tulip);
    private FlowerPack pack4 = new FlowerPack(flower2,6);
    private FlowerPack[] packs2= {pack3,pack4};
    private  FlowerBucket bucket2 = new FlowerBucket(packs1);
